// creates element
      ...
      el.style.borderStyle = "hidden hidden hidden solid";
      el.style.outline = "0";
      el.style.margin = "10px 0px 0px";
      ...
      el.setAttribute("id", "pin");
      document.getElementById('coolPasswordThing').appendChild(el);
      el = document.getElementById("pin")
      el.style.width = "75px";
      el.style.borderStyle = "hidden hidden solid hidden";
      el.style.outline = "0";
      el.style.padding = "5px";
      ...
      el.setAttribute("placeholder", "Length");
      el.setAttribute("id", "length");
      el.setAttribute("min", "10");
      el.setAttribute("max", "25");
      document.getElementById('coolPasswordThing').appendChild(el);
      el = document.getElementById("length");
      el.style.borderStyle = "solid solid solid solid";
      el.style.outline = "0";
      el.style.margin = "10px 0px 10px";
      el.style.padding = "5px";
